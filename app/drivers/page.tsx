    ...
    <div className="p-4 grid grid-cols-1 gap-2 md:grid-cols-3">
      ...
      {data.map((driver) => (
        <Card key={driver.driver_number} className="@container/card">
          <CardHeader>
            <CardTitle className="text-muted-foreground text-sm mt-1 font-semibold @[250px]/card:text-3xl flex items-center gap-2">
              {driver.team_name}
            </CardTitle>
            <CardAction>
              <Badge
          ...
          <CardContent className="text-xl font-semibold @[250px]/card:text-3xl flex items-center gap-2">
