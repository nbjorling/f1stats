            ...
            <CardContent className="text-xl font-semibold  flex items-center gap-2">
              <p className="flex flex-col grow">
                ...
                <span className="text-lg flex flex-row items-center mt-1">
                  ...
                  <span className="text-muted-foreground text-sm font-normal">{getCountryFullName(driver.country_code)}</span>
                </span>
              </p>
              {driver.headshot_url && (
                <div className="relative w-20 h-20 rounded-full overflow-hidden border-2 bg-muted" style={{ borderColor: `#${driver.team_colour}40` }}>
                    <Image
