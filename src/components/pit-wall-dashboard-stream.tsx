        ...
        <Card className="bg-zinc-900/50 backdrop-blur-2xl border-zinc-800 shadow-xl overflow-hidden">
          ...
          <CardContent className="p-0">
            ...
            <div className="flex items-center text-[9px] font-black text-zinc-600 uppercase px-3 py-2 border-b border-zinc-800/50 bg-black/20">
              <span className="w-4 md:w-6 text-center">POS</span>
              <span className="flex-1 shrink-0 ml-4">DRIVER</span>
              <span className="w-20 text-right md:text-center">BEST LAP</span>
              <span className="w-14 text-center hidden md:block">GAP</span>
              <span className="w-20 text-right md:text-center">LAP TIME</span>
            ...
            <div className="p-1 space-y-0.5 max-h-[70vh] overflow-y-auto">
              {drivers
                ...
                .map((d, idx) => (
                  ...
                  >
                    {/* POS */}
                    <span className="w-3 md:w-6text-center font-black text-xs text-zinc-400">
                      {idx + 1}
                    </span>
                    ...
                    <div className="flex items-center flex-1 ml-4 min-w-0 ">
                      ...
                      />
                      <span className="ml-2  font-black text-xs tracking-tight text-white whitespace-nowrap overflow-hidden text-ellipsis">
                        {d.name}{' '}
                    ...
                    {/* GAP */}
                    <span className="hidden md:block w-14 text-right font-mono text-[11px] font-bold text-zinc-400 tabular-nums">
